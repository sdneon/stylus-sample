...
public class AwtInfoView extends JPanel implements InfoView {
    public final static boolean FULL_INFO = false;
	...
	private void initialize() {
        ...
        if (FULL_INFO)
        {
            ...
            size = AwtUtils.getTextSize(xPosLabel, 10000, "%,10.4f");
        ...
        {
            size = AwtUtils.getTextSize(pressureLabel, 10000, "%,10.4f");
        }
