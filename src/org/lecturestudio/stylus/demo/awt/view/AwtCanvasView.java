...
import org.lecturestudio.stylus.demo.awt.render.ComicsFrameRenderer;
import org.lecturestudio.stylus.demo.awt.render.ImageRenderer;
import org.lecturestudio.stylus.demo.awt.render.PenRenderer;
import org.lecturestudio.stylus.demo.awt.render.RectRenderer;
...
public class AwtCanvasView extends JPanel implements CanvasView {
	...
	private <S extends Shape> void renderShape(S shape) {
        ...
        graphics2D.setClip(0, 0, getWidth(), getHeight()); //SD: try to let render know canvas size
	...
	private void initialize() {
		...
		setRenderer(ImageShape.class, new ImageRenderer());
		setRenderer(ComicsFrameShape.class, new ComicsFrameRenderer());
		setRenderer(RectShape.class, new RectRenderer());
